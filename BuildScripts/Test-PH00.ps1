...
$heldStart=Get-Date
$heldProcess=Start-Process -FilePath $heldExe -ArgumentList @('-HeldSmoke','-RenderOffscreen','-windowed','-ForceRes',"-ResX=$Width","-ResY=$Height",'-unattended') -WindowStyle Hidden -PassThru
